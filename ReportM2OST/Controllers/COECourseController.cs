...
namespace ReportM2OST.Controllers
{
    ...
    public class COECourseController : ApiController
    {
        [HttpOptions]
        ...
        [Route("~/api/CourseCompletion")]
        [AllowAnonymous]
        [HttpPost]
        [HttpOptions]
        public HttpResponseMessage COECourse([FromBody] CourseCompletionRequest request)
        {
            try
            {
                if (request.orgid == 0)
                ...
                var ID_category1 = request.ID_category;
                ...
                var employeeInfo1 = employeeService.COECourse(orgid,category, rolewise, assessment_id, startDate,endDate, regionwise, user_designation, usercity, ID_category).Result;
        ...
        [Route("~/api/GetAssessmenttitle")]
        [AllowAnonymous]
        [HttpGet]
        [HttpOptions]
        public HttpResponseMessage GetAssessmenttitle(int orgid, string id_category_heading)
        {
            try
            {
                if (orgid == 0)
                ...
                CommonFunction employeeService = new CommonFunction();
                var employeeInfo = employeeService.tbl_assessment_title(orgid, id_category_heading);
        ...
        public HttpResponseMessage Getcourse(int orgid, string id_category_heading, string monthwise)
        {
            try
            {
                ...
                CommonFunction employeeService = new CommonFunction();
                var employeeInfo = employeeService.tbl_category(orgid, id_category_heading, year, month);
        ...
        [Route("~/api/Getcategoryheading")]
        [AllowAnonymous]
        [HttpGet]
        [HttpOptions]
        public HttpResponseMessage Categoryheading(int orgid,string monthwise)
        {
            try
            {
                string year = string.Empty;
                ...
                CommonFunction employeeService = new CommonFunction();
                var employeeInfo = employeeService.categoryheading(orgid, year, month);
        ...
        [Route("~/api/Getuserdesignation")]
        [AllowAnonymous]
        [HttpPost]
        [HttpOptions]
        public HttpResponseMessage Getuserdesignation(CourseCompletionRequest request)
        {
            try
            {
                if (request.orgid == 0)
                ...
                var employeeInfo = employeeService.Getuserdesignation(orgid, roleId);
        ...
        [Route("~/api/Getusercity")]
        [AllowAnonymous]
        [HttpPost]
        [HttpOptions]
        public HttpResponseMessage Getusercity(CourseCompletionRequest request)
        {
            try
            {
                if (request.orgid == 0)
               ...
               // var roleId_1 = request.rolewise;
                ...
                var employeeInfo = employeeService.Getusercity(orgid, regionwise);
